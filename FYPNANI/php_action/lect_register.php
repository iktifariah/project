...
//mysql_query($sql1); 
	...
	mysql_query("INSERT INTO lect_register(lect_id,batch_id,class_id) VALUES('".$_SESSION['SESS_MEMBER_ID']."', '$_POST[batch_id]', '$_POST[class_id]')");

echo '<br> data inserted...';
header("location:http://localhost/FYPNANI/lecturer.php");
